...
# Vehicle Transport Calculator

A web application that calculates journey times and fuel consumption for different vehicles.

## Features
- Calculate travel time based on distance
- Compare multiple vehicle options
- Check fuel efficiency and range limitations
...
## Vehicle Data
Includes information for various vehicles with:
- Top speed (km/h)
